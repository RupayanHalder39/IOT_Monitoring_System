...
var altitudeHistoryDiv = document.getElementById("oxygen-history");

var temperatureGaugeDiv = document.getElementById("temperature-gauge");
var humidityGaugeDiv = document.getElementById("humidity-gauge");
var pressureGaugeDiv = document.getElementById("gas-gauge");
var altitudeGaugeDiv = document.getElementById("oxygen-gauge");
...
function updateBoxes(temperature, humidity, pressure, altitude) {
  ...
  let pressureDiv = document.getElementById("gas");
  let altitudeDiv = document.getElementById("oxygen");
